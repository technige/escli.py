...
from elasticsearch_serverless import Elasticsearch, ConnectionError, AuthenticationException, TransportError
...
class ElasticsearchServerlessClient(Client):
    """ Client for use with Elasticsearch Serverless.
    """
